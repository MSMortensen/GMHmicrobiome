...
You can run a PERMANOVA for each pairwise combination of groups in a variable we use the `permanova_pairwise` from the package \code{ecole}.
...
permanova_pairwise(dist.used, grp = mdat[,VAR])
